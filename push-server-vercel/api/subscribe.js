// POST /subscribe  { operatorId, subscription }
// Stores the subscription in Redis (Upstash or Vercel KV), keyed by operatorId.
...
export default async function handler(req, res) {
  ...
  const { operatorId, subscription } = req.body || {};
  ...
  await redis.set('sub:' + operatorId, JSON.stringify(subscription));
